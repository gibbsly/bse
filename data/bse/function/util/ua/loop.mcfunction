...
title @a[gamemode=!survival,gamemode=!adventure] actionbar [{"text":"Un-Marking all spawners ","color":"aqua"},{"score":{"name":"id=","objective":"bse.main"},"color":"aqua"},{"text":" (","color":"gray"},{"score":{"name":"processed=","objective":"bse.main"},"color":"green"},{"text":"/","color":"gray"},{"score":{"name":"total=","objective":"bse.main"},"color":"green"},{"text":")","color":"gray"}]
