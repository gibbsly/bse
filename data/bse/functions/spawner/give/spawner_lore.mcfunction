...
##generating text
#ID and weight
data modify block 29999999 1 6452069 Text1 set value '[{"translate":" Entity: %s, Weight: %s","color":"gray","italic":false,"with":[{"nbt":"spt[0].data.entity.id","storage":"bse:main","color":"green"},{"nbt":"spt[0].Weight","storage":"bse:main","color":"gold"}]}]'
data modify storage bse:main item.tag.display.Lore append from block 29999999 1 6452069 Text1

#name if available
execute if data storage bse:main spt[0].data.entity.CustomName run data modify block 29999999 1 6452069 Text1 set value '[{"translate":" Name: %s","color":"gray","italic":false,"with":[{"nbt":"spt[0].data.entity.CustomName","storage":"bse:main","color":"green","interpret":true}]}]'
execute if data storage bse:main spt[0].data.entity.CustomName run data modify storage bse:main item.tag.display.Lore append from block 29999999 1 6452069 Text1
...
data modify block 29999999 1 6452069 Text1 set value '{"italic":false,"color":"gray","translate":" Max Block Light: %s, Max Sky Light: %s","with":[{"nbt":"temps.1","storage":"bse:main","color":"gold"},{"nbt":"temps.2","storage":"bse:main","color":"gold"}]}'
data modify storage bse:main item.tag.display.Lore append from block 29999999 1 6452069 Text1
