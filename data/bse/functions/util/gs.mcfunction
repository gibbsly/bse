...
#generating name
data modify block 29999999 1 6452069 front_text.messages[0] set value '[{"text":"","italic":false},{"text":"Place Spawner","color":"yellow"}," ",{"translate":"[ID: %s]","with":[{"score":{"objective":"bse.main","name":"id="},"color":"gold"}],"color":"gray"}]'
data modify storage bse:main item.tag.display.Name set from block 29999999 1 6452069 front_text.messages[0]
...
data modify block 29999999 1 6452069 front_text.messages[0] set value '[{"translate":" Player Range: %s, Spawn Range: %s","color":"gray","italic":false,"with":[{"nbt":"temps.1","storage":"bse:main","color":"gold"},{"nbt":"temps.2","storage":"bse:main","color":"gold"}]}]'
...
data modify block 29999999 1 6452069 front_text.messages[0] set value '[{"translate":" Max Delay: %s, Min Delay: %s","color":"gray","italic":false,"with":[{"nbt":"temps.1","storage":"bse:main","color":"gold"},{"nbt":"temps.2","storage":"bse:main","color":"gold"}]}]'
data modify storage bse:main item.tag.display.Lore append from block 29999999 1 6452069 front_text.messages[0]
