...
execute at @p run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:[bse.spawner,bse.spawner.new],Duration:10000,CustomName:'"bse - new spawner"'}
execute as @e[type=minecraft:area_effect_cloud,tag=bse.spawner.new,limit=1] align xyz positioned ~0.5 ~0.5 ~0.5 run function bse:use_tool/new_marker
