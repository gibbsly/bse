...
#invalid range error
execute if score @s bse.request matches -2147483648.. unless score @s bse.request matches -53 unless score @s bse.request matches -2.. run tellraw @s ["",{"text":"[BSE]:","color":"yellow","bold":true}," ",{"text":"Invalid request; unknown value","color":"red"}]
